...
export interface ApiFeaturedProductFeaturedProduct
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::featured-product.featured-product', 'Name'> &
      Attribute.Required;
    ColorVariants: Attribute.Component<
      'featured-product.featured-variants',
      true
    > &
      Attribute.Required;
    createdAt: Attribute.DateTime;
...
export interface ApiKidsCategoryKidsCategory extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    slug: Attribute.UID<'api::kids-category.kids-category', 'name'>;
    kids_products: Attribute.Relation<
      'api::kids-category.kids-category',
      'manyToMany',
...
export interface ApiKidsProductKidsProduct extends Schema.CollectionType {
  ...
  attributes: {
    Name: Attribute.String;
    slug: Attribute.UID<'api::kids-product.kids-product', 'Name'>;
    Description: Attribute.RichText;
    ColorVariants: Attribute.Component<'kids-product.kids-variants', true>;
    kids_categories: Attribute.Relation<
      'api::kids-product.kids-product',
      'manyToMany',
      'api::kids-category.kids-category'
    >;
...
export interface ApiMensCategoryMensCategory extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    slug: Attribute.UID<'api::mens-category.mens-category', 'name'>;
    mens_products: Attribute.Relation<
      'api::mens-category.mens-category',
      'manyToMany',
...
export interface ApiMensProductMensProduct extends Schema.CollectionType {
  ...
  attributes: {
    Name: Attribute.String;
    Description: Attribute.RichText;
    slug: Attribute.UID<'api::mens-product.mens-product', 'Name'>;
    ColorVariants: Attribute.Component<'mens-product.mens-variants', true>;
    mens_categories: Attribute.Relation<
      'api::mens-product.mens-product',
      'manyToMany',
      'api::mens-category.mens-category'
    >;
...
export interface ApiNewArrivalProductNewArrivalProduct
  extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Description: Attribute.RichText & Attribute.Required;
    slug: Attribute.UID<
      'api::new-arrival-product.new-arrival-product',
      'Name'
    > &
      Attribute.Required;
    ColorVariants: Attribute.Component<'product.new-arrival-variant', true> &
      Attribute.Required &
      Attribute.SetMinMax<
        {
          min: 1;
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    apartment: Attribute.RichText;
    orderStatus: Attribute.Enumeration<
      ['pending', 'processing', 'shipped', 'delivered', 'cancelled']
    >;
    paymentStatus: Attribute.Enumeration<['pending', 'paid', 'failed']>;
...
export interface ApiWomensCategoryWomensCategory extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    slug: Attribute.UID<'api::womens-category.womens-category', 'name'>;
    womens_products: Attribute.Relation<
      'api::womens-category.womens-category',
      'manyToMany',
...
export interface ApiWomensProductWomensProduct extends Schema.CollectionType {
  ...
  attributes: {
    Name: Attribute.String;
    Description: Attribute.RichText;
    slug: Attribute.UID<'api::womens-product.womens-product', 'Name'>;
    ColorVariants: Attribute.Component<'womens-product.womens-variants', true>;
    womens_categories: Attribute.Relation<
      'api::womens-product.womens-product',
      'manyToMany',
      'api::womens-category.womens-category'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::kids-category.kids-category': ApiKidsCategoryKidsCategory;
      'api::kids-product.kids-product': ApiKidsProductKidsProduct;
      'api::mens-category.mens-category': ApiMensCategoryMensCategory;
      'api::mens-product.mens-product': ApiMensProductMensProduct;
      'api::new-arrival-product.new-arrival-product': ApiNewArrivalProductNewArrivalProduct;
      'api::order.order': ApiOrderOrder;
      'api::order-item.order-item': ApiOrderItemOrderItem;
      'api::womens-category.womens-category': ApiWomensCategoryWomensCategory;
